...
$ret = "SELECT * FROM  invoice_products  GROUP BY staff_number";
...
?>
    <option value="<?php echo $order->staff_number; ?>"><?php echo $order->staff_number; ?></option>
              ...
              <div class="row align-items-center">
                ...
                // echo $ret;
                  ...
                  ?>
                      ...
                      <input type="hidden" name="employee_id" value="<?php echo $order->staff_number?>">
                  <?php } ?>
            ...
            <div class="table-responsive">
              ...
              <table class="table align-items-center table-flush">
                <thead class="thead-light">
                  <tr>
                    <th class="text-success" scope="col"><b>STAFF NUMBER</b></th>
                ...
                <tbody>
                  ...
                  ?>
                    <tr>
                      <th class="text-success" scope="row"><?php echo $order->staff_number; ?></th>
